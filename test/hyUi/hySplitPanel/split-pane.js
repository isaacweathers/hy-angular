...
describe('Directive: split-pane', function () {
    ...
    it('should test only a content pane', function(){
        element = angular.element('<split-pane '+
            ' >' +
        ...
        var leftPane = angular.element(element[0].querySelector('aside.splitter-left'));
        expect(leftPane.length).toBe(0);
        var rightPane = angular.element(element[0].querySelector('aside.splitter-right'));
    ...
    it('Test toggle of left pane', function(){
        ...
        element = compile(element)(scope);
        scope.$digest();
        var leftDiv = angular.element(element[0].querySelector('aside.splitter-left div'));
        var leftSpan = angular.element(element[0].querySelector('aside.splitter-left'));
    ...
    it('Test toggle of right pane', function(){
        ...
        element = compile(element)(scope);
        scope.$digest();
        var rightDiv = angular.element(element[0].querySelector('aside.splitter-right div'));
        var rightSpan = angular.element(element[0].querySelector('aside.splitter-right'));
